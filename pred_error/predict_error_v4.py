...
"""
Variante de predict_error mais qui prédit le nombre d'erreur avec une classification
...
model.add(Dropout(0.2))
model.add(Dense(7, activation='sigmoid')) #'sigmoid'
...
pickle.dump(X_train, open("pickle/X_train3.pck", "wb"))
pickle.dump(X_test, open("pickle/X_test3.pck", "wb"))
pickle.dump(y_train, open("pickle/y_train3.pck", "wb"))
pickle.dump(y_test, open("pickle/y_test3.pck", "wb"))
pickle.dump(pred, open("pickle/pred3.pck", "wb"))
